...
public class ArrayComparator {
    ...
    public static boolean equals(int[] first, int[] second) {
        // TODO-00: Use the appropriate method from java.util.Arrays to compare single-dimensional arrays.
        // Hint: Look for a method that compares array content, not references.
    ...
    public static boolean deepEquals(int[][] first, int[][] second) {
        // TODO-01: Use the appropriate method from java.util.Arrays for multi-dimensional arrays.
        // Hint: This method recurses into nested arrays.
